...
namespace Distance.NoCameraShake
{
    /// <summary>
    ...
    public sealed class Mod : MonoBehaviour
    {
        ...
        public void LateInitialize(IManager manager)
        {
            ...
            var harmony = new Harmony("blu3.NoCameraShake.patch");
            harmony.PatchAll();
    ...
    [HarmonyPatch(typeof(CameraShake), nameof(CameraShake.ShakeCamera), typeof(float), typeof(float))]
    internal class NoCameraShakePatch
    {
